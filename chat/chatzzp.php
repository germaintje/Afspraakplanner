    ...
    <body style="margin: 0;">  
		<div class="header">
			<div class="topnav" id="myTopnav">
				<a class="pontes" href="../view/zzp-er/home.php"><img class="pontesimg" src="../view/images/afspraakplanner.jpg" alt="afspraakplanner"></a>
				<a class="nieuw" href="chatzzp.php">Chatten</a>
				<a class="nieuw" href="../view/zzp-er/alleklanten.php">Alle klanten</a>
				<div class="welkom">
        ...
        <div class="container">
			<div class="row">
				...
				<h3 align="center" style="padding:0;">Chat met klanten</h3>
			</div>
